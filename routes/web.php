...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/casa/escolher', [HouseController::class, 'choose'])->name('house.choose');
    Route::post('/casa/criar', [HouseController::class, 'store'])->name('house.store');
    Route::post('/casa/entrar', [HouseController::class, 'join'])->name('house.join');
    Route::get('/casas', [HouseController::class, 'list'])->name('houses.list');

    // Main app routes (require house selection)
    Route::middleware('house')->group(function () {
        Route::patch('/casa/{house}/ativa', [HouseController::class, 'setActive'])->name('house.set-active');
